...
public class PayrollCalculator {
    ...
    double allowances = getEffectiveAllowances(emp);
    ...
    if (!"Probationary".equalsIgnoreCase(emp.getStatus())) {
        rice = safe(emp.getRiceSubsidy());
        phone = safe(emp.getPhoneAllowance());
        clothing = safe(emp.getClothingAllowance());
    }
    ...
    private double getEffectiveAllowances(Employee emp) {
