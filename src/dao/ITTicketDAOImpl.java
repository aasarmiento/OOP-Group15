...
public List<ITTicket> getAllTickets() {
    ...
    try (BufferedReader br = new BufferedReader(new FileReader(file))) {
        ...
        while ((line = br.readLine()) != null) {
            ...
            // CRITICAL: Stop reading if we hit the audit log section
...
public boolean addTicket(ITTicket ticket) {
    // Convert Object back to CSV Line (OOP Encapsulation)
    ...
    try {
        // N-Tier: Writing to the physical resource
