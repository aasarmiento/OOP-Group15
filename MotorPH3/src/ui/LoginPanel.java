...
private JPanel createLeftPanel() {
    ...
    // 1. Load the Logo (VS Code friendly)
    try {
        // This looks for the logo in the folder where your compiled classes are
        java.net.URL imgURL = getClass().getResource("/logo.png");
        
        // If it's inside a folder called resources under src, use:
        if (imgURL == null) {
        ...
        if (imgURL != null) {
            ...
            System.out.println("VS Code Debug: Still can't find logo.png. Try moving it to the 'src' folder.");
        }
    } catch (Exception e) {
        e.printStackTrace();
    }
